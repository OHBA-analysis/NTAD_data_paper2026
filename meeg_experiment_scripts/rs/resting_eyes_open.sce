#Resting state eyes open for the DFP project(Ece Kocagoncu,2017)
#ek390@cam.ac.uk
...
eye.set_parameter("get_edf_file", "C:\\Users\\wayne\\Desktop\\Experiments\\SHINE\\6-Resting_state_ET\\logfiles\\eyelink_RSO.edf");
eye.stop_tracking();
